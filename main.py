...
bot = telebot.TeleBot(BOT_TOKEN)  # Fixed bot token syntax
...
def send_welcome(message):
    bot.send_message(message.chat.id, "👋 Welcome! Please send your Free Fire ID to check your account status.")
